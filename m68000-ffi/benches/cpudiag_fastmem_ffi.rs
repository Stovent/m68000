...
extern "C" fn set_byte(addr: u32, _data: u8, _user_data: *mut c_void) -> bool {
    match addr {
...
struct Scc68070 {
    cpu: *mut M68000<cpu_details::Mc68000>,
...
pub fn criterion_benchmark(c: &mut Criterion) {
    ...
    c.bench_function("cpudiag m68000_mc68000_fastmem_interpreter", |b|
        b.iter_batched_ref(setup, |scc68070| {
            unsafe {
                for _ in 0..10_000_000 {
                    black_box(m68000_mc68000_fastmem_interpreter(scc68070.cpu, &raw mut scc68070.fastmem));
                }
            }
        }, criterion::BatchSize::SmallInput)
    );

    c.bench_function("cpudiag m68000_mc68000_fastmem_interpreter_exception", |b|
        b.iter_batched_ref(setup, |scc68070| {
            unsafe {
                for _ in 0..10_000_000 {
                    black_box(m68000_mc68000_fastmem_interpreter_exception(scc68070.cpu, &raw mut scc68070.fastmem));
                }
            }
        }, criterion::BatchSize::SmallInput)
    );
...
fn make_fastmem(bios_data: &[u8]) -> (m68000_fastmem_t, Pin<Box<Memory>>) {
    const OFFSET_BITS: u32 = 19;
    const RAM_BANK_SIZE: usize = 1 << 19;
