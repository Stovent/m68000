...
(Get-Content $ffi_header -Raw) -replace "#include ""m68000.h""", "#include ""m68000.h""`r`n`r`ntypedef struct m68000_mc68000_s m68000_mc68000_t;`r`ntypedef struct m68000_scc68070_s m68000_scc68070_t;" | Out-File -encoding ASCII $ffi_header
