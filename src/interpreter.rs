...
impl M68000 {
    ...
    pub fn interpreter<M: MemoryAccess>(&mut self, memory: &mut M) -> usize {
        ...
        if let Some(vector) = self.exceptions.pop_front() {
            if memory.exception(vector) {
                cycle_count += self.process_exception(memory, vector);
            }
        }
        ...
        let pc = self.pc;
        let opcode = self.get_next_word(memory);
        ...
        cycle_count += (entry.execute)(self, memory, &mut instruction);
        cycle_count
    }

    pub(super) fn unknown_instruction(&mut self, _: &mut impl MemoryAccess, _: &mut Instruction) -> usize {
        self.exception(Vector::IllegalInstruction as u8);
        0
    }

    pub(super) fn abcd(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn add(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn adda(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn addi(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn addq(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn addx(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn and(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (reg, dir, size, ea) = inst.operands.register_direction_size_effective_address();
    ...
    pub(super) fn andi(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (size, ea, imm) = inst.operands.size_effective_address_immediate();
    ...
    pub(super) fn andiccr(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn andisr(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        if self.sr.s {
            let imm = inst.operands.immediate();
            self.sr &= imm;
            1
    ...
    pub(super) fn asm(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn asr(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn bcc(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn bchg(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn bclr(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (ea, mut count) = inst.operands.effective_address_count();
    ...
    pub(super) fn bra(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn bset(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (ea, mut count) = inst.operands.effective_address_count();
    ...
    pub(super) fn bsr(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let disp = inst.operands.displacement();
    ...
    pub(super) fn btst(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (ea, mut count) = inst.operands.effective_address_count();
    ...
    pub(super) fn chk(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn clr(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn cmp(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn cmpa(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (reg, size, ea) = inst.operands.register_size_effective_address();
    ...
    pub(super) fn cmpi(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (size, ea, imm) = inst.operands.size_effective_address_immediate();
    ...
    pub(super) fn cmpm(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn dbcc(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn divs(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (reg, ea) = inst.operands.register_effective_address();
    ...
    pub(super) fn divu(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (reg, ea) = inst.operands.register_effective_address();
    ...
    pub(super) fn eor(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (reg, _, size, ea) = inst.operands.register_direction_size_effective_address();
    ...
    pub(super) fn eori(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (size, ea, imm) = inst.operands.size_effective_address_immediate();
    ...
    pub(super) fn eoriccr(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let imm = inst.operands.immediate();
    ...
    pub(super) fn eorisr(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        if self.sr.s {
            let imm = inst.operands.immediate();
            self.sr ^= imm;
            1
    ...
    pub(super) fn exg(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn ext(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn illegal(&mut self, _: &mut impl MemoryAccess, _: &mut Instruction) -> usize {
        self.exception(Vector::IllegalInstruction as u8);
        0
    }

    pub(super) fn jmp(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn jsr(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let ea = inst.operands.effective_address();
    ...
    pub(super) fn lea(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (reg, ea) = inst.operands.register_effective_address();
    ...
    pub(super) fn link(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn lsm(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (dir, ea) = inst.operands.direction_effective_address();
    ...
    pub(super) fn lsr(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (rot, dir, size, mode, reg) = inst.operands.rotation_direction_size_mode_register();
    ...
    pub(super) fn r#move(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn movea(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn moveccr(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let ea = inst.operands.effective_address();
    ...
    pub(super) fn movefsr(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let ea = inst.operands.effective_address();
    ...
    pub(super) fn movesr(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        if self.sr.s {
            let ea = inst.operands.effective_address();
    ...
    pub(super) fn moveusp(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        if self.sr.s {
    ...
    pub(super) fn movem(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn movep(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn moveq(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn muls(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (reg, ea) = inst.operands.register_effective_address();
    ...
    pub(super) fn mulu(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (reg, ea) = inst.operands.register_effective_address();
    ...
    pub(super) fn nbcd(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let ea = inst.operands.effective_address();
    ...
    pub(super) fn neg(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (size, ea) = inst.operands.size_effective_address();
    ...
    pub(super) fn negx(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (size, ea) = inst.operands.size_effective_address();
    ...
    pub(super) fn nop(&mut self, _: &mut impl MemoryAccess, _: &mut Instruction) -> usize {
        1
    }

    pub(super) fn not(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (size, ea) = inst.operands.size_effective_address();
    ...
    pub(super) fn or(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (reg, dir, size, ea) = inst.operands.register_direction_size_effective_address();
    ...
    pub(super) fn ori(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (size, ea, imm) = inst.operands.size_effective_address_immediate();
    ...
    pub(super) fn oriccr(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let imm = inst.operands.immediate();
    ...
    pub(super) fn orisr(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        if self.sr.s {
            let imm = inst.operands.immediate();
            self.sr |= imm;
            1
    ...
    pub(super) fn pea(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let ea = inst.operands.effective_address();
    ...
    pub(super) fn reset(&mut self, memory: &mut impl MemoryAccess, _: &mut Instruction) -> usize {
        if self.sr.s {
            memory.reset();
            1
        } else {
    ...
    pub(super) fn rom(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (dir, ea) = inst.operands.direction_effective_address();
    ...
    pub(super) fn ror(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (rot, dir, size, mode, reg) = inst.operands.rotation_direction_size_mode_register();
    ...
    pub(super) fn roxm(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (dir, ea) = inst.operands.direction_effective_address();
    ...
    pub(super) fn roxr(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (rot, dir, size, mode, reg) = inst.operands.rotation_direction_size_mode_register();
    ...
    pub(super) fn rte(&mut self, memory: &mut impl MemoryAccess, _: &mut Instruction) -> usize {
        if self.sr.s {
    ...
    pub(super) fn rtr(&mut self, memory: &mut impl MemoryAccess, _: &mut Instruction) -> usize {
    ...
    pub(super) fn rts(&mut self, memory: &mut impl MemoryAccess, _: &mut Instruction) -> usize {
        self.pc = self.pop_long(memory);

        1
    }

    pub(super) fn sbcd(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn scc(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn stop(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let imm = inst.operands.immediate();
    ...
    pub(super) fn sub(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (reg, dir, size, ea) = inst.operands.register_direction_size_effective_address();
    ...
    pub(super) fn suba(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (reg, size, ea) = inst.operands.register_size_effective_address();
    ...
    pub(super) fn subi(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (size, ea, imm) = inst.operands.size_effective_address_immediate();
    ...
    pub(super) fn subq(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (imm, size, ea) = inst.operands.data_size_effective_address();
    ...
    pub(super) fn subx(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn swap(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
    ...
    pub(super) fn tas(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let ea = inst.operands.effective_address();
    ...
    pub(super) fn trap(&mut self, _: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let vector = inst.operands.vector();
        self.exception(vector);
        0
    }

    pub(super) fn trapv(&mut self, _: &mut impl MemoryAccess, _: &mut Instruction) -> usize {
        if self.sr.v {
    ...
    pub(super) fn tst(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let (size, ea) = inst.operands.size_effective_address();
    ...
    pub(super) fn unlk(&mut self, memory: &mut impl MemoryAccess, inst: &mut Instruction) -> usize {
        let reg = inst.operands.register();
